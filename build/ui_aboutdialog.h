...
"Copyright &copy; 2011-YYYY The BITTX developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About BITTX", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>BITTX</b> version", 0));
